...
require 'volt/daterange/version'

Gem::Specification.new do |spec|
  spec.name          = "volt-daterange"
  spec.version       = Volt::Daterange::VERSION
  spec.authors       = ["Ryan Stout"]
  spec.email         = ["ryanstout@gmail.com"]
  spec.summary       = %q{Volt wrapper for daterangepicker (bootstrap date picker)}
  spec.homepage      = ""
  spec.license       = "MIT"
